...

{
	...
	{		
		//if(_firstHit) exitWith {_firstHit = false;systemChat "bail";};
...
{	
	...
	[_vehicle, _x, _preferredMag] call fatLurch_fnc_loadAmmoFromInventory;		//TODO try to avoid deleting ALL magazines, rendering this moot
